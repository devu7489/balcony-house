...
export default function Home() {
  const { hotelName, tagline, heroImageUrl, childcareEnabled } = useHotelConfig()
  ...
  return (
    <div>
      <section className="px-4 md:px-8 pt-4 md:pt-6">
        <div className="relative w-full aspect-[3/2] max-h-[85vh] min-h-[480px] rounded-xl2 overflow-hidden flex items-end">
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-10 pb-8 md:pb-16 w-full text-warmwhite">
            ...
            <p className="hidden sm:block max-w-xl text-warmwhite/90 mb-5 sm:mb-8 text-sm sm:text-lg" style={{ textShadow: '0 2px 12px rgba(0,0,0,0.3)' }}>
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-10 pt-24 pb-4">
        ...
        <div className={`grid gap-6 ${childcareEnabled ? 'md:grid-cols-2' : 'max-w-xl mx-auto'}`}>
          <div className="bg-white border border-stone rounded-xl2 p-8">
            ...
            <p className="hidden sm:block text-charcoal/70 mb-6">
            ...
            <ul className="hidden sm:grid grid-cols-2 gap-y-2 text-sm text-charcoal/70">
          ...
          {childcareEnabled && (
            <div className="bg-white border border-stone rounded-xl2 p-8">
              ...
              <p className="hidden sm:block text-sm text-charcoal/60">Choose it as an add-on at checkout, for any room or trip length.</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section className="hidden sm:block max-w-4xl mx-auto px-6 py-24 text-center">
